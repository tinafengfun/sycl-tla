                ...
                with_result_metadata(
                    {
                        ...
                        "workspace_bytes": parse_metric(stripped, "workspace_bytes"),
                        "input_bytes_per_buffer": parse_metric(stripped, "input_bytes_per_buffer"),
                        "input_pool_target_bytes": parse_metric(stripped, "input_pool_target_bytes"),
                        "input_pool_buffers": parse_metric(stripped, "input_pool_buffers") or parse_metric(stripped, "pool_buffers"),
                        "fixed_vram_input": parse_metric(stripped, "fixed_vram_input"),
                        "prebuilt_variants": parse_metric(stripped, "prebuilt_variants"),
                        "workspace_reuse_enabled": parse_metric(stripped, "workspace_reuse_enabled"),
